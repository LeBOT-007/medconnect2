...
if (isset($_GET['action']) && $_GET['action'] === 'annuler' && isset($_GET['id_rdv'])) {
    ...
    // On sécurise en vérifiant que le rendez-vous appartient bien au patient connecté via son compte utilisateur
    $stmt = $pdo->prepare("
            ...
            <div class="card-body p-0">
                <?php if (!$prochain_rdv): ?>
                    <div class="text-center p-5 text-muted bg-white">
                        ...
                        <small class="text-white-50 d-block mt-1">Cliquez sur le bouton ci-dessus pour réserver une consultation.</small>
                    </div>
                <?php else: ?>
